  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="mortgage applications, loan officers, home loans, hassle-free home buying, mortgage solutions, secure home loans"
        />
        ...
        <meta
          property="og:image"
          content="https://1stclasshomemortgage.com/og-image.jpg"
        />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image: "https://1stclasshomemortgage.com/og-image.jpg",
              potentialAction: {
                "@type": "SearchAction",
                target:
