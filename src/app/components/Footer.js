...
const navigation = {
  contact: [
    { name: formattedPhone, href: `tel:${phoneNumber}` },
    { name: "loans@troywarner.com", href: "mailto:loans@troywarner.com" },
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/1stClassHomeMortgage",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/firstclasshomemortgage/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/first-class-home-mortgage/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.5 8.98h4.96v13.52H.5V8.98zM8.08 8.98h4.74v1.85h.07c.66-1.25 2.28-2.57 4.7-2.57 5.02 0 5.94 3.31 5.94 7.61v6.63h-4.96v-5.87c0-1.4-.03-3.21-2.45-3.21-2.46 0-2.84 1.52-2.84 3.1v6h-4.96V8.98z" />
        </svg>
      ),
    },
    {
      name: "YouTube",
      href: "https://www.youtube.com/@firstclasshomemortgagetroy3144",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 lg:px-8 lg:pt-24">
        ...
        <div className="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0">
            &copy; 2025 First Class Home Mortgage. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
