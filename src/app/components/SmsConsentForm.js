  ...
  if (status === "success") {
    return (
      <p className="text-green-700 font-medium">
        Thanks! You&apos;re opted in to receive text updates from First Class
        Home Mortgage.
      </p>
    );
  }
    ...
    >
      ...
      <div className="flex items-start gap-2">
        ...
        <label htmlFor="consent" className="text-sm text-gray-700">
          I agree to receive informational and marketing SMS text messages
          from First Class Home Mortgage, including mortgage updates, market
          resources, events, and follow-up communications. Message frequency
          varies. Message and data rates may apply. Reply STOP to cancel,
          HELP for help. I agree to the{" "}
