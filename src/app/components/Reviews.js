  ...
  return (
    <section className="bg-white px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-4xl text-center">
        <h2 className="text-3xl font-bold text-[#004e82] sm:text-4xl">
          Helping Utah families and homeowners since 1992.
        </h2>
        <p className="mt-4 text-lg text-gray-600">
          We shop multiple lenders to find the right mortgage solution for you.
        </p>
      ...
      <div
        className="mx-auto mt-14 grid max-w-6xl gap-6 transition-opacity duration-500 lg:grid-cols-3"
        style={{ opacity: show ? 1 : 0 }}
      >
        {visible.map((review) => (
          <figure
            key={review.author}
            className="flex flex-col rounded-2xl bg-gray-50 p-8 text-sm/6 shadow-[0_8px_16px_rgba(145,149,157,0.15)]"
          >
            <Stars />
